...
contract StakeGame is Initializable, IERC721Receiver {
    ...
    function initialize(IERC721 _stakeItem) public initializer {
        ...
        stakeCoin = StakeCoin(address(proxy));
    ...
    function getClaimReward(
        uint256 tokenId
    ) public view returns (uint256 tokenReward, uint256 nextClaimTime) {
